  ...
  return (
    <div className='flex flex-col items-center gap-6'>
      ...
      <div className='grid grid-cols-2 gap-4 w-3xl max-sm:grid-cols-1 max-sm:w-full max-md:w-full'>
        <InputContainer>
          <Label isTask2 label='First Name*' />
          <Input
        ...
        <InputContainer>
          <Label isTask2 label='Phone Number*' />
          <Input
        ...
        <InputContainer>
          <Label isTask2 label='Confirm Password*' />
          <Input
